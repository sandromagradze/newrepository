  ...
  const content = compact ? (
    <div className="flex flex-row gap-2 bg-white p-3 items-center">
      ...
      <div className="flex-1 flex flex-col gap-1 min-w-0">
        ...
        <h2 className="text-xs flex  font-bold text-[#333333] leading-tight hover:text-blue-600 cursor-pointer line-clamp-2">
          {title}
        </h2>
      </div>
    </div>
    ...
    <div className="flex flex-col-reverse md:flex-row gap-4 bg-white p-2 items-center">
      <div className="flex-1 flex flex-col gap-2">
        <span className="text-xs font-bold text-[#424242]">
          {time}
        </span>
